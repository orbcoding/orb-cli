...
Describe '_orb_parse_declared_args'
  It 'calls its functions'
    _orb_get_declared_args_and_start_indexes() { spec_fns+=( $(echo_fn) ); }
    ...
    The variable 'spec_fns[@]' should equal "_orb_get_declared_args_and_start_indexes _orb_validate_declared_args _orb_get_declared_args_lengths _orb_parse_declared_args_options"
  End
End

# _orb_get_declared_args_and_start_indexes
Describe '_orb_get_declared_args_and_start_indexes'
  ...
  It 'stores args, vars and start indexes'
    When call _orb_get_declared_args_and_start_indexes
    The status should be success
  ...
  It 'supports declared aliases for short and verbose flags'
    ...
    When call _orb_get_declared_args_and_start_indexes
    The status should be success
    The variable "_orb_declared_args[@]" should equal "-b -f"
    The variable "_orb_declared_arg_aliases[-b]" should equal "-b"
    The variable "_orb_declared_arg_aliases[--boolean]" should equal "-b"
    The variable "_orb_declared_arg_aliases[--file]" should equal "-f"
    The variable "_orb_declared_arg_suffixes[-f]" should equal "1"
  End
End
...
Describe '_orb_get_declared_arg_context'
  It 'returns context for non-suffixed arg declaration'
    declaration=(-f = file)
    When call _orb_get_declared_arg_context 1 arg_raw arg_start_i
  ...
  It 'returns context for suffixed alias declaration'
    ...
    When call _orb_get_declared_arg_context 2 arg_raw arg_start_i
...
Describe '_orb_get_declared_arg_keys'
  It 'extracts canonical key as first alias'
    When call _orb_get_declared_arg_keys '-f|--file' keys arg
...
Describe '_orb_store_declared_arg_suffix'
  declare -A _orb_declared_arg_suffixes

  It 'stores suffix when argument is suffixed'
    declaration=(-f 2 = file)
    When call _orb_store_declared_arg_suffix -f 0 2
    The variable "_orb_declared_arg_suffixes[-f]" should equal 2
  End

  It 'does not store suffix for non-suffixed args'
    declaration=(-f = file)
    When call _orb_store_declared_arg_suffix -f 0 1
    The variable "_orb_declared_arg_suffixes[-f]" should be undefined
  End
End

# _orb_store_declared_arg_start_index
Describe '_orb_store_declared_arg_start_index'
  declare -A declared_args_start_indexes

  It 'stores canonical arg start index'
    When call _orb_store_declared_arg_start_index -f 3
    The variable "declared_args_start_indexes[-f]" should equal 3
  End
End

# _orb_store_declared_arg_aliases
Describe '_orb_store_declared_arg_aliases'
  declare -A _orb_declared_arg_aliases

  It 'stores all aliases mapped to canonical key'
    When call _orb_store_declared_arg_aliases -f -f --file
    The variable "_orb_declared_arg_aliases[-f]" should equal -f
    The variable "_orb_declared_arg_aliases[--file]" should equal -f
  End

  It 'raises on conflicting alias mapping'
    _orb_declared_arg_aliases=([--file]=-x)
    _orb_raise_invalid_declaration() { echo_fn "$@" && exit 1; }
    When run _orb_store_declared_arg_aliases -f --file
...
Describe '_orb_store_declared_arg_variable_or_comment'
  ...
  It 'raises for invalid variable names when not raw'
    _orb_declared_raw=false
    _orb_raise_invalid_declaration() { echo_fn "$@" && exit 1; }
    When run _orb_store_declared_arg_variable_or_comment -f "invalid name" false
    The status should be failure
